...
rho_ind=10
fig,axes=plt.subplots(max(len(plotted_profiles),len(plotted_parameters),len(plotted_actuators)),3, sharex='col', figsize=(8,5))
...
plt.savefig(f'gyroPlots{sample_ind}_False.svg', format='svg')
plt.show()
